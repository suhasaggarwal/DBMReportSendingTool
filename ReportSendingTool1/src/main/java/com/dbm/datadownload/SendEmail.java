...
*/	
     ...
     // Sender's email ID needs to be mentioned
     String from = "no-reply@cuberoot.co";//change accordingly
     ...
     try {
        ...
        // Set Subject: header field
        message.setSubject("Cuberoot British Council Report Attached");

        // Now set the actual message
        BodyPart messageBodyPart = new MimeBodyPart();

        // Now set the actual message
        messageBodyPart.setText("Hi, "+ "\n\n\n"+ "Cuberoot British Council Report is attached" + "\n\n\n" + "Regards," +"\n" + "Cuberoot Team");
        ...
        addAttachment(multipart, "BritishCouncilReport1.csv");
        addAttachment(multipart, "Reach.png");
        addAttachment(multipart, "Impressions.png");
        addAttachment(multipart, "Clicks.png");
        addAttachment(multipart, "CTR.png");
